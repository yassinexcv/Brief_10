...
class pluginform{
    ...
    <div style="background-image:url('https://img.freepik.com/vecteurs-libre/conception-fond-abstrait-blanc_23-2148825582.jpg?w=2000')  ;" class="bg-no-repeat bg-cover object-cover  m-auto rounded-lg p-5">
    ...
    <div class="">
        ...
        <form action="" method="post" class="">
            ...
            <li>
                ...
                <label class="" for="very satisfied">tres satisfait </label>
                <div class=""></div>
            </li>
            <li>
                <input class="" type="radio" name="view" value="satisfied" id="satisfied"> 
                <label class="" for="satisfied"> satisfait </label>
                <div class=""></div>
            </li>
            <li>
                <input class="" type="radio" name="view" value="neutral" id="neutral">
                <label class="" for="neutral">naturele</label>
                <div class=""></div>
            </li>
            <li>
                <input class="" type="radio" name="view" value="unsatisfied" id="unsatisfied"> 
                <label class="" for="unsatisfied">non satisfait </label>
                <div class=""></div>

            <li>
                <input class="" type="radio" name="view" value="very unsatisfied" id="very unsatisfied"> 
                <label class="" for="very unsatisfied">en colere</label>
                <div class=""></div>
            </li>
            </ul>
            <h2 class="">Si vous avez des commentaires spécifiques, écrivez-nous..</h2>
            <div><input class="mt-5" style=" width: 100%; padding: 12px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius:4px;box-sizing: border-box;" type="text" placeholder="Your Name (optional)" name="name"/></div>
            <div><input class="mt-5" style=" width: 100%; padding: 12px 20px; margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius:4px;box-sizing: border-box;" type="email" placeholder="Your Email (optional)" name="email"/></div>
            <div><textarea placeholder="message" class="h-24 w-full rounded-lg" name="comments" required=""></textarea></div>

            <div><input type="hidden" name="id" value="<?php echo get_the_ID() ?> "></div>
             <input type="submit" name="submit" value="submit" style="border-radius: 12px; " class="btn mt-4 " /> 
        </form>
    </div>
</div>
